...
int main ()
{
    ...
    for(int i=0; i<4; i++)
    {
        ...
        if(chance<9&&chance>0)//these are the odds of getting this encounter
        {
        ...
        else if(chance<13&&chance>7)//these are the odds of getting this encounter
        {
            ...
            if(secret1choice==3)//this is an if command which will only activates when you have selected the third option from the secret encounter
            {
                ...
                {
                    cout<<"You outran the dummy! You won!"<<endl;// text line
                    score=score+5;//adds 5 points to your score
                }
    ...
    cout<<"Congratulations!! You passed the training camp. You have earned yourself a weapon! Chose yours wisely: "<<endl;//// text line. This is where you have the option to select one out of four weapons whcih you can see on the next line 
    cout<<"  sword            pistol          rock            German dictionary"<<endl;// text line
    cout<<"    1                2               3                       4 "<<endl;
    cin>>weapon;
    //////////////////////////////////////////////////////////////////
    ...
    for(int i=0; i<8; i++)// between lines 115 and 118 is where we use a loop for and give the letter "i" values which represent the odds of a certain encounter happening. We use the command rand to generate a random number between 1 and 12. Here is how we distributed the odds in the first round: the chance of getting into a regular encounter is 6/12, the chances of loosing a heart is 3/12 and getting the secret encounter is 3/12
    {
        srand(time(0));
    ...
    /////////////////////////////////////////////////////////////////////////////////
    if(heart==0)//this checkes if you are out of hearts and displays the followning text if the statement is true and it's game over. Break heare isn't nessesary becuase the if is already 
    {
        cout<<endl;
    }
    else if(heart>0)
